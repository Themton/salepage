...
export default function AdminDashboard() {
  ...
  const handleFlashCreate = async (parcel) => {
    ...
    setEditModal({
      ...
      receiver_province: parcel.receiver_province || parcel.sp_orders?.customer_province || parcel.sp_orders?.meta?.province || '',
      receiver_district: parcel.receiver_district || parcel.sp_orders?.customer_district || parcel.sp_orders?.meta?.district || '',
      receiver_subdistrict: parcel.receiver_subdistrict || parcel.sp_orders?.customer_subdistrict || parcel.sp_orders?.meta?.subdistrict || '',
      receiver_postal: parcel.receiver_postal || parcel.sp_orders?.customer_zip || parcel.sp_orders?.meta?.zip || '',
